...
function newRow(id) {
    return "<div class=\"row\"><div class=\"col-md-4\">" +
        ...
        + "<input  class=\"form-control petitChampNiveau\" id=\"CommentairesExterneContents_"+id+"__Niveau\" name=\"CommentairesExterneContents["+id+"].Niveau\" value=\"0\" type=\"text\" disabled=\"disabled\" >"
